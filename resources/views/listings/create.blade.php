<x-app-layout>
    <section class="text-gray-600 body-font overflow-hidden">
        <div class="container w-full md:w-1/2 py-24 mx-auto">
            <div class="mb-4">
    ...
    <script>
        ...
        const cardElement = elements.create('card', {
            classes: {
                base: 'StripeElement rounded-md shadow-sm bg-white px-3 py-4 border border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block my-2 w-full'
            }
        });
